...
class __$$IdleCopyWithImpl<T, $Res>
    extends _$ActionStateCopyWithImpl<T, $Res, _$Idle<T>>
...
abstract class Idle<T> implements ActionState<T> {
...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$ActionStateCopyWithImpl<T, $Res, _$Success<T>>
...
abstract class Success<T> implements ActionState<T> {
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$ActionStateCopyWithImpl<T, $Res, _$Loading<T>>
...
abstract class Loading<T> implements ActionState<T> {
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$ActionStateCopyWithImpl<T, $Res, _$Error<T>>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'ActionState<$T>.error(message: $message)';
  }
...
abstract class Error<T> implements ActionState<T> {
